...
public class BattleCharmItem extends Item {
    ...
    private static final DustParticleEffect MAIN =
            new DustParticleEffect(new Vector3f(0.8471f, 0.2039f, 0.3373f), 2.0f * DUST_SIZE_SCALE);
    private static final DustParticleEffect GLOW =
            new DustParticleEffect(new Vector3f(0.9725f, 0.4549f, 0.6510f), 2.4f * DUST_SIZE_SCALE);
    private static final DustParticleEffect DARK =
            new DustParticleEffect(new Vector3f(0.6863f, 0.1451f, 0.2118f), 1.6f * DUST_SIZE_SCALE);
